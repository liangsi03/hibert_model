...
class PredictionDecoderLayer(tf.keras.layers.Layer):
    def __init__(self, d_model, num_heads, dff, rate=0.1):
        super(PredictionDecoderLayer, self).__init__()
...
class PredictionDecoder(tf.keras.layers.Layer):
    def __init__(self, num_layers, d_model, num_heads, dff, target_vocab_size, rate=0.1):
        ...
        self.dec_layers = [PredictionDecoderLayer(d_model, num_heads, dff, rate) for _ in range(num_layers)]
